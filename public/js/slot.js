/* ==========================================================================
   iCHANCE — لعبة "صيّاد الجوائز" (منطق المتصفح)
   --------------------------------------------------------------------------
...
function buildPaytable() {
  ...
  el('payRules').innerHTML = `
    ...
    <div><b>أقصى رهان</b> — ${fmt(CFG.maxStake)} للدورة. نسبة العائد واحدة عند كل مبلغ،
         بلا أي سقف على المضاعف يميّز رهاناً عن آخر.</div>
    <div><b>شراء الميزة</b> — ${CFG.featureBuyCost}× الرهان مقابل ${CFG.freeSpins.base} دورات مجانية.
         السعر محسوب من قيمتها المتوقعة فلا يمنح أفضلية لأي طرف.</div>
    <div><b>الأرقام المعلنة</b> — نسبة العائد ${CFG.rtp}% · نسبة الدورات الرابحة ${CFG.hitRate}% ·
