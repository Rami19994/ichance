...
//   0  = كرت خاسر (يذهب المبلغ) — 50% من الكروت
//   1  = استرداد المبلغ فقط (ليس ربحاً) — 25%
//  >1 = ربح فعلي — 3 كروت بالضبط في كل نمط بلا استثناء، ومداها ×2 إلى ×100
//
// ── كيف رُفع العائد من 80.42% إلى 96%
// العائد هنا صريح: اللاعب يسحب كرتاً من اثني عشر، فالعائد متوسط مضاعفاتها:
//     RTP = (عدد كروت الاسترداد + مجموع الكروت الرابحة) ÷ 12
//
// كان أمامنا طريقان: تكبير الجوائز، أو تكثير كروت الاسترداد. اخترنا الثاني.
// تكبير الجوائز يرفع تذبذب أرباح الموقع ويزيد تعرّضه لضربة واحدة، بينما
// كرت الاسترداد يكلّف واحداً بالضبط، لا مفاجأة فيه، ويحوّل ثلث الخسائر إلى
// «استرجعت مالك» — وهو أفضل ما يقع للاعب بعد الربح. فصار:
//   ربح 25% · استرداد 25% · خسارة 50%     (كان: 25% · 10% · 65%)
//
// المتوسط الموزون للكروت الرابحة = 8.52، فالعائد = (3 + 8.52) ÷ 12 = 96.00%
// بالضبط، وهامش الموقع 4.00% مضمون بحكم الجدول لا بالتقدير.
//
// ⚠ سقف المضاعف على الرهانات الكبيرة (HIGH_STAKE_MAX_MULTIPLIER) يخفض
// العائد إلى 89.5% لمن يراهن بـ12800 فأكثر. القاعدة معلنة قبل الرهان،
// وهي ثمن حماية الموقع من ×100 على أكبر مبلغ.
//
...
// ---------------------------------------------------------------------------
const TEMPLATES = [
  { key: 'trio',     name: 'ثلاثي متواضع',  weight: 100, cards: [0, 0, 0, 0, 0, 0, 1, 1, 1, 2, 2, 2] },
  { key: 'balanced', name: 'متوازن',        weight: 330, cards: [0, 0, 0, 0, 0, 0, 1, 1, 1, 2, 2, 3] },
  { key: 'rising',   name: 'صاعد',          weight: 350, cards: [0, 0, 0, 0, 0, 0, 1, 1, 1, 2, 3, 3] },
  { key: 'five',     name: 'الخمسة',        weight: 100, cards: [0, 0, 0, 0, 0, 0, 1, 1, 1, 2, 2, 5] },
  { key: 'five2',    name: 'خمسة مزدوجة',   weight:  50, cards: [0, 0, 0, 0, 0, 0, 1, 1, 1, 2, 3, 5] },
  { key: 'ten',      name: 'العشرة',        weight:  50, cards: [0, 0, 0, 0, 0, 0, 1, 1, 1, 2, 2, 10] },
  { key: 'twenty',   name: 'العشرون',       weight:  14, cards: [0, 0, 0, 0, 0, 0, 1, 1, 1, 2, 2, 20] },
  { key: 'fifty',    name: 'الخمسون',       weight:   5, cards: [0, 0, 0, 0, 0, 0, 1, 1, 1, 2, 2, 50] },
  { key: 'hundred',  name: 'المئة',         weight:   1, cards: [0, 0, 0, 0, 0, 0, 1, 1, 1, 2, 2, 100] }
];
